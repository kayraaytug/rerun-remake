...
void SceneDepth::Show()
{
    ...
    if (ImGui::Begin(SCENEDEPTH, &Open, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar))
    {
        if (ImGui::IsWindowFocused()) dataManager.selectedWindow = SCENEDEPTH;
        if (!textures.empty())
        {
